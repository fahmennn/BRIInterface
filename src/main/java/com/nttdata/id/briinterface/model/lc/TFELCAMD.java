...
// Export LC Amendment
@JacksonXmlRootElement(localName = "TFELCAMD")
@JsonInclude(JsonInclude.Include.NON_EMPTY)
public class TFELCAMD {
  ...
  @JacksonXmlProperty(localName = "DocumentsReceived")
  ...
  @JacksonXmlProperty(localName = "EventNotifications")
  ...
  @Size(min = 1, max = 1, message = "ApplcableRules must be 1 character")
