...
// Import LC Issuance
@JacksonXmlRootElement(localName = "TFILCAPP")
...
public class TFILCAPP {
	...
	@JacksonXmlProperty(localName = "ApplcableRules", namespace = "urn:messages.service.ti.apps.tiplus2.misys.com")
	// @Size(min = 1, max = 1, message = "ApplcableRules must be minimum and maximum 1 character")
	private String applcableRules;

	@JacksonXmlProperty(localName = "ApplcableRulesNarrative", namespace = "urn:messages.service.ti.apps.tiplus2.misys.com")
	// @NotBlank(message = "ApplcableRulesNarrative is mandatory")
	// @Size(max = 35, message = "ApplcableRulesNarrative must be maximum 35 characters")
	private String applcableRulesNarrative;
	...
	@JacksonXmlProperty(localName = "PreAdvise", namespace = "urn:messages.service.ti.apps.tiplus2.misys.com")
	private Boolean preAdvise;
	...
	@JacksonXmlProperty(localName = "InstructionsToApplicant", namespace = "urn:messages.service.ti.apps.tiplus2.misys.com")
	// @Size(max = 1820, message = "InstructionsToApplicant must be maximum 1820 characters")
	private String instructionsToApplicant;

	@JacksonXmlProperty(localName = "FinalWording", namespace = "urn:messages.service.ti.apps.tiplus2.misys.com")
	// @NotBlank(message = "FinalWording is mandatory")
	// @Size(max = 53600, message = "FinalWording must be maximum 53600 characters")
	private String finalWording;
	...
	public Boolean getPreAdvise() {
		return preAdvise;
	}

	public void setPreAdvise(Boolean preAdvise) {
	...
	public String getInstructionsToApplicant() {
		return instructionsToApplicant;
	}

	public void setInstructionsToApplicant(String instructionsToApplicant) {
		this.instructionsToApplicant = instructionsToApplicant;
	}

	public String getFinalWording() {
		return finalWording;
	}

	public void setFinalWording(String finalWording) {
		this.finalWording = finalWording;
	}
